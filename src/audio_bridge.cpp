...
#ifndef NDEBUG
#define AV_DEBUG_LOG(stmt) do { stmt; } while (0)
#else
#define AV_DEBUG_LOG(stmt) do {} while (0)
#endif
...
int main()
{
    ...
    capture_device = selected_capture_device;
    playback_device = selected_playback_device;
